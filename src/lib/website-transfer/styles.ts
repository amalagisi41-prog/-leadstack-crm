...
export function classlessSnapshotStyles(html: string, force = false): string {
  ...
  if (!force && (head.match(/\bclass\s*=/gi) ?? []).length > 10) return "";
...
export function classlessSemanticLayoutStyles(): string {
  return `html,body{margin:0;min-width:0;max-width:100%;overflow-x:hidden;background:#fff;color:#18303a;font-family:Manrope,Arial,sans-serif}img,svg,video,canvas{display:block;max-width:100%;height:auto}main>div>div>header{position:relative;display:block;padding:0;background:#0b1f2a;color:#fff}main>div>div>header>nav{position:absolute;top:0;left:0;right:0;z-index:20;display:flex;align-items:center;justify-content:space-between;gap:24px;width:100%;padding:24px clamp(20px,5vw,80px);box-sizing:border-box;color:#fff}main>div>div>header>nav>a:first-child img{display:block;width:min(190px,22vw);max-width:190px;height:auto}main>div>div>header>nav>div{display:flex;align-items:center;gap:6px}main>div>div>header>nav>div a{color:inherit;text-decoration:none}main>div>div>header>nav>div:first-of-type{padding:10px 18px;border:1px solid rgba(255,255,255,.08);border-radius:999px;background:rgba(11,31,42,.72);backdrop-filter:blur(12px)}main>div>div>header>nav>div:first-of-type a{padding:8px 12px;font-size:15px;font-weight:600;white-space:nowrap}main>div>div>header>nav>div:nth-of-type(2){gap:10px}main>div>div>header>nav>div:nth-of-type(2) a{padding:12px 20px;border-radius:999px;font-weight:700;white-space:nowrap}main>div>div>header>nav>div:nth-of-type(2) a:last-child{background:#d4ad42;color:#102330}main>div>div>header>section:first-of-type{position:relative;display:flex;flex-direction:column;justify-content:center;min-height:720px;overflow:hidden;padding:150px 20px 90px;text-align:center;color:#fff;background:#0b1f2a}main>div>div>header>section:first-of-type>div:first-child{position:absolute;inset:0;z-index:0}main>div>div>header>section:first-of-type img[alt*="drone"]{display:block;width:100%;height:100%;object-fit:cover;opacity:.78}main>div>div>header>section:first-of-type>div:nth-child(2){position:relative;z-index:2;display:flex;flex-direction:column;align-items:center;gap:18px}main>div>div>header>section:first-of-type h1{max-width:1000px;margin:0;color:#fff;font-size:clamp(42px,6vw,88px);font-weight:800;line-height:.98;letter-spacing:-.04em;text-shadow:0 3px 18px rgba(0,0,0,.35)}main>div>div>header>section:first-of-type h1 span{white-space:pre-line}main>div>div>header>section:first-of-type h1+div{font-size:clamp(16px,2vw,24px);font-weight:700}main>div>div>header>section:first-of-type form{display:flex;width:min(800px,92vw);margin-top:12px;background:#fff;border-radius:8px;overflow:hidden}main>div>div>header>section:first-of-type form input{flex:1;min-width:0;border:0;padding:20px;font-size:16px;color:#18303a}main>div>div>header>section:first-of-type form button{width:76px;border:0;background:#0b2944}main>div>div>header>section:first-of-type>div:nth-child(3) a{display:inline-block;padding:16px 32px;background:#0b2944;color:#fff;font-weight:800;letter-spacing:.04em;text-decoration:none}main>div>div>header>section>section[data-ahn-home-listings]{padding:14px 0 24px;background:#fff}main>div>div>header>section>section[data-ahn-home-listings]>div:first-child{text-align:center;color:#d4ad42;font-weight:800;letter-spacing:.2em}
main>div>div>section:not([data-ahn-home-listings]),main>div>div>div>section{display:block!important;opacity:1!important;transform:none!important;padding:72px clamp(20px,6vw,96px);background:#fff;color:#18303a;font-family:Manrope,Arial,sans-serif}
main>div>div>div>section:first-of-type{padding-top:140px;background:linear-gradient(135deg,#0b1f2a 0%,#123d52 58%,#1d6b7b 100%);color:#fff}
main>div>div>div>section:first-of-type>div{width:100%;max-width:1200px;margin:0 auto}
main>div>div>div>section:first-of-type h1{max-width:760px;margin:12px 0 18px;color:#fff;font-family:Sora,Manrope,Arial,sans-serif;font-size:clamp(34px,5vw,68px);line-height:1.04;letter-spacing:-.04em}
main>div>div>div>section:first-of-type h2{color:#102d3a;font-family:Sora,Manrope,Arial,sans-serif;font-size:28px}
main>div>div>div>section:first-of-type p{color:rgba(255,255,255,.82);font-size:17px;line-height:1.6}
main>div>div>div>section:first-of-type>div>div:nth-child(2){display:grid;grid-template-columns:minmax(0,1fr) minmax(320px,520px);gap:48px;align-items:start;margin-top:36px}
main>div>div>div>section:first-of-type form{display:grid;gap:14px;padding:28px;border-radius:14px;background:#fff;color:#18303a;box-shadow:0 14px 34px rgba(0,0,0,.2)}
main>div>div>div>section:first-of-type form>div{display:grid;gap:6px}
main>div>div>div>section:first-of-type label{color:#526875;font-size:13px;font-weight:700}
main>div>div>div>section:first-of-type input,main>div>div>div>section:first-of-type select{width:100%;min-height:44px;padding:10px 12px;border:1px solid #cbd8dc;border-radius:6px;background:#fff;color:#18303a;box-sizing:border-box}
main>div>div>div>section:first-of-type form>button{min-height:48px;border:0;border-radius:6px;background:#0b2944;color:#fff;font-weight:800}
main>div>div>div>section:not(:first-of-type)>div{width:100%;max-width:1200px;margin:0 auto}
main>div>div>div>section:not(:first-of-type) h2{margin:8px 0 18px;color:#102d3a;font-family:Sora,Manrope,Arial,sans-serif;font-size:clamp(28px,4vw,52px);line-height:1.05}
main>div>div>div>section:not(:first-of-type) h3{margin:0 0 8px;color:#102d3a;font-family:Sora,Manrope,Arial,sans-serif;font-size:18px}
main>div>div>div>section:not(:first-of-type) p{margin:0 0 14px;color:#526875;font-size:16px;line-height:1.65}
main>div>div>div>section:not(:first-of-type) a{color:#0b5c78;font-weight:700;text-decoration:none}
main>div>div>div>section:not(:first-of-type)>div>div{max-width:100%}
main>div>div>div>footer{display:block!important;padding:64px clamp(20px,6vw,96px) 28px;background:#0b1f2a;color:rgba(255,255,255,.78);font-family:Manrope,Arial,sans-serif}
main>div>div>div>footer a{color:#fff;text-decoration:none}
...
@media(max-width:767px){main>div>div>header>section:first-of-type{min-height:680px;padding-top:130px}main>div>div>header>section:first-of-type h1{font-size:42px}main>div>div>section:not([data-ahn-home-listings]),main>div>div>div>section{padding:52px 20px}main>div>div>section#connect>div>div,main>div>div>section#why-artisan>div>div,main>div>div>div>section:first-of-type>div>div:nth-child(2){grid-template-columns:1fr;gap:28px}main>div>div>section#how-it-works>div>div:nth-child(2){grid-template-columns:1fr 1fr}main>div>div>footer>div>div:first-child,main>div>div>div>footer>div>div:first-child{grid-template-columns:1fr;gap:28px}main>div>div>footer+div{padding:12px 16px}main>div>div>footer+div>div{align-items:flex-start;flex-direction:column;gap:12px}}`;
}
...
/* AHN interior pages use one fewer wrapper than the home-page capture. */
main>div>header{position:relative;display:block;padding:0;background:#0b1f2a;color:#fff}
main>div>header>nav{position:relative;z-index:20;display:flex;align-items:center;justify-content:space-between;gap:24px;width:100%;padding:24px clamp(20px,5vw,80px);box-sizing:border-box;color:#fff}
main>div>header>nav>a:first-child img{display:block;width:min(190px,22vw);max-width:190px;height:auto}
main>div>header>nav>div{display:flex;align-items:center;gap:6px}
main>div>header>nav>div a{color:inherit;text-decoration:none}
main>div>header>nav>div:first-of-type{padding:10px 18px;border:1px solid rgba(255,255,255,.08);border-radius:999px;background:rgba(11,31,42,.72);backdrop-filter:blur(12px)}
main>div>header>nav>div:first-of-type a{padding:8px 12px;font-size:15px;font-weight:600;white-space:nowrap}
main>div>header>nav>div:nth-of-type(2){gap:10px}
main>div>header>nav>div:nth-of-type(2) a{padding:12px 20px;border-radius:999px;font-weight:700;white-space:nowrap}
main>div>header>nav>div:nth-of-type(2) a:last-child{background:#d4ad42;color:#102330}
main>div>div>section{display:block!important;opacity:1!important;transform:none!important;padding:72px clamp(20px,6vw,96px);background:#fff;color:#18303a;font-family:Manrope,Arial,sans-serif}
main>div>div>section:first-of-type{padding-top:72px;background:linear-gradient(135deg,#0b1f2a 0%,#123d52 58%,#1d6b7b 100%);color:#fff}
main>div>div>section:first-of-type>div{width:100%;max-width:1200px;margin:0 auto}
main>div>div>section:first-of-type h1{max-width:760px;margin:12px 0 18px;color:#fff;font-family:Sora,Manrope,Arial,sans-serif;font-size:clamp(34px,5vw,68px);line-height:1.04;letter-spacing:-.04em}
main>div>div>section:first-of-type h2{color:#102d3a;font-family:Sora,Manrope,Arial,sans-serif;font-size:28px}
main>div>div>section:first-of-type p{color:rgba(255,255,255,.82);font-size:17px;line-height:1.6}
main>div>div>section:first-of-type>div>div:nth-child(2){display:grid;grid-template-columns:minmax(0,1fr) minmax(320px,520px);gap:48px;align-items:start;margin-top:36px}
main>div>div>section:first-of-type form{display:grid;gap:14px;padding:28px;border-radius:14px;background:#fff;color:#18303a;box-shadow:0 14px 34px rgba(0,0,0,.2)}
main>div>div>section:first-of-type form>div{display:grid;gap:6px}
main>div>div>section:first-of-type label{color:#526875;font-size:13px;font-weight:700}
main>div>div>section:first-of-type input,main>div>div>section:first-of-type select{width:100%;min-height:44px;padding:10px 12px;border:1px solid #cbd8dc;border-radius:6px;background:#fff;color:#18303a;box-sizing:border-box}
main>div>div>section:first-of-type form>button{min-height:48px;border:0;border-radius:6px;background:#0b2944;color:#fff;font-weight:800}
main>div>div>section:not(:first-of-type)>div{width:100%;max-width:1200px;margin:0 auto}
main>div>div>section:not(:first-of-type) h2{margin:8px 0 18px;color:#102d3a;font-family:Sora,Manrope,Arial,sans-serif;font-size:clamp(28px,4vw,52px);line-height:1.05}
main>div>div>section:not(:first-of-type) h3{margin:0 0 8px;color:#102d3a;font-family:Sora,Manrope,Arial,sans-serif;font-size:18px}
main>div>div>section:not(:first-of-type) p{margin:0 0 14px;color:#526875;font-size:16px;line-height:1.65}
main>div>div>section:not(:first-of-type) a{color:#0b5c78;font-weight:700;text-decoration:none}
main>div>div>footer{display:block!important;padding:64px clamp(20px,6vw,96px) 28px;background:#0b1f2a;color:rgba(255,255,255,.78);font-family:Manrope,Arial,sans-serif}
main>div>div>footer a{color:#fff;text-decoration:none}
main>div>div>footer img{display:block;max-width:190px;height:auto}
@media(max-width:767px){main>div>header>nav{padding:16px 18px}main>div>header>nav>div:first-of-type,main>div>header>nav>div:nth-of-type(2){display:none}main>div>header>nav>div:nth-of-type(3){display:flex;gap:8px}main>div>div>section{padding:52px 20px}main>div>div>section:first-of-type{padding-top:52px}main>div>div>section:first-of-type>div>div:nth-child(2){grid-template-columns:1fr;gap:28px}}
`;
}
