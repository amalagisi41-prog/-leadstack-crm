...
const steps = [
  {
    ...
    icon: Inbox,
    title: "Lead comes in",
    body: "From Zillow, your website, a yard sign text, or a referral — AgentStack captures every inquiry and responds in under 60 seconds.",
  ...
  },
  {
    ...
    body: "AgentStack follows up from offer to closing day — then automatically asks for a Google review at exactly the right moment.",
    iconColor: "text-indigo-500",
    iconBg: "bg-indigo-500/10",
    numColor: "text-indigo-600",
    numBg: "bg-indigo-50 border-indigo-200",
