import { Sparkles, ArrowRight, Clock, TrendingUp, DollarSign, Play } from "lucide-react";
  ...
  return (
    <section className="relative overflow-hidden py-14 md:py-20">
      ...
      <div className="container mx-auto px-4">
        {/* Centered hero lockup — the above-the-fold impact block */}
        <div className="flex flex-col items-center text-center">
          ...
          {/* "SEE IT IN ACTION" video anchor */}
          <a
            href="#video-teaser"
            className="mt-10 inline-flex items-center gap-2.5 rounded-full border border-[#3b82f6]/25 bg-[#3b82f6]/[0.06] px-5 py-2.5 text-sm font-semibold text-[#1b3d7a] transition-colors hover:bg-[#3b82f6]/[0.12]"
          >
            <span className="flex h-7 w-7 items-center justify-center rounded-full bg-[#3b82f6] text-white">
              <Play className="ml-0.5 h-3.5 w-3.5" fill="currentColor" />
            </span>
            <span className="uppercase tracking-wider">See it in action</span>
            <span className="hidden sm:inline">—</span>
            <span className="hidden text-muted-foreground sm:inline">Watch the AgentStack difference</span>
          </a>
        ...
        {/* Pipeline mockup — below the centered hero */}
