...
export default function StatusPage() {
  return (
    <PublicInfoShell
      ...
      title="Beta systems are operating normally."
      intro="This page reports the public beta's product state. Provider-specific incidents and scheduled maintenance will be added here as production monitoring is connected."
    >
      <div className="rounded-2xl border border-emerald-200 bg-white p-6 shadow-sm">
        <div className="flex items-center gap-3">
          <span className="h-3 w-3 rounded-full bg-emerald-500" />
          <h2 className="text-lg font-semibold">No known beta-wide incident</h2>
        </div>
