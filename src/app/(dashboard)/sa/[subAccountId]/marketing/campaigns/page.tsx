...
export default function MarketingCampaignsPage() {
  ...
  return <div className="space-y-6">
    ...
    <div className="rounded-2xl border bg-card p-5">
      ...
      <button type="button" className="mt-3 text-xs underline" onClick={() => setManual((v) => !v)}>{manual ? "Use synced IDX listing" : "Enter listing details manually"}</button>
